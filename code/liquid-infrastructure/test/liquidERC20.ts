...
async function basicNftManagementTests(infraERC20: LiquidInfrastructureERC20, nftAccount1: HardhatEthersSigner, nftAccount2: HardhatEthersSigner, badSigner: HardhatEthersSigner) {
...
export async function transferNftToErc20AndManage(infraERC20: LiquidInfrastructureERC20, nftToManage: LiquidInfrastructureNFT, nftOwner: HardhatEthersSigner) {
...
async function failToManageNFTBadSigner(infraERC20BadSigner: LiquidInfrastructureERC20, nftToManage: LiquidInfrastructureNFT, nftOwner: HardhatEthersSigner) {
...
async function basicErc20HolderTests(infraERC20: LiquidInfrastructureERC20, holder1: HardhatEthersSigner, holder2: HardhatEthersSigner, badSigner: HardhatEthersSigner) {
    const infraERC20NotOwner = infraERC20.connect(badSigner)
